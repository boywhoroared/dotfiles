...
Plug 'calebsmith/vim-lambdify', { 'for': ['scheme','racket'] }
...
Plug 'othree/xml.vim'
Plug 'mattn/emmet-vim', { 'for': ['php', 'html', 'javascript', 'python'] }
...
Plug 'reedes/vim-wordy', { 'for': ['markdown', 'text', 'mail', 'asciidoc', 'rst']}
...
Plug 'boywhoroared/vim-colors-mac_classic'
